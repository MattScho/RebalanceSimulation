...
import gym
from Environments.BikeShare.SimpleScenarioDistributed.SimpleScenario_Env import SimpleScenarioEnv
...
for agent in agentsToTest.keys():
    ...
    callback = LogResultsCallback(check_freq=2400, log_dir=log_dir, verbose=1)
    # Train the agent
    time_steps = 60000
